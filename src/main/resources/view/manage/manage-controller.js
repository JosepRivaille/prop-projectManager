(function () {
    ...
    function ManageCtrl($rootScope, $mdDialog, $filter) {
        ...
        vm.propBackend = $rootScope.propBackend;
        ...
        var response = vm.propBackend.searchForAllDocuments();
        ...
        vm.showDeleteConfirm = function (event, document, propBackend) {

            alert("In function -> " + propBackend);
            ...
            $mdDialog.show(confirm, propBackend).then(function() {
                var data = JSON.stringify(document);
                propBackend.deleteDocument(data);
